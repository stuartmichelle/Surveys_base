...
################################################################
# Script to read in gpx files from Philippines 2014 fieldwork
source("~/Desktop/2015_01_conv/readGPXGarmin_2014_06_07.R")
options(digits=22)
...
infile = readGPXGarmin(paste('gpx', 1, '/', files[[1]][1], sep='')) # read in first file to get column names
...
surv = read.csv('GPSSurveys2015.surveyinfo.csv')
data = read.csv('GPSSurveys2015.clownfish.csv', stringsAsFactors=FALSE)
